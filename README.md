...
| `SITE_URL` | origin у листах verify / reset (runtime, Next не інлайнить). На проді без змінної або з localhost — `https://nmt.in.ua` |
| `MAIL_SITE_URL` | запасний origin для листів; дефолт як `SITE_URL` |
